...
class App extends Container
{
    ...
    public function __construct(string $rootPath = '')
    {
        ...
        //绑定了默认的服务提供者，一共提供了两个，app\Request 和 app\ExceptionHandle，实际上你使用的 Request 就是它
        ...
        //将 App($this) 实例 绑定到容器中，分别是 app 和 think\\Container (App 类是继承 Container 的，所以就是将自身实例绑定到容器中)
    ...
    public function initialize()
    {
        ...
        // 初始化 (目前在初始化的时候只有下面三个服务，在 $this->initializers 数组中)
        /* 这三个服务分别是：
