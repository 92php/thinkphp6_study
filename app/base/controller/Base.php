...
class Base extends BaseController
{
     ...
     * @return array
     */
    static public function returnCode()
    {
     ...
     * @return array
     */
    public function buildParam($array, $uuid = false)
    {
        $data = [];
    ...
    public function checkLoginGlobal()
    {
        ...
        switch ($this->loginType) {
            ...
            case "session";
                ...
                $this->member_info = Session::get('member_info');
        ...
        if ($member_info) {
            switch ($this->loginType) {
                ...
                case "session":
                    ...
                    Session::set('uuid', $member_info['uuid']);
                    if ((Session::has("uuid"))) {
                        $set_success = true;
                    }
                    break;
     ...
     * @return string
     */
    public function create_uuid($str)
    {
        $chars = md5(uniqid(mt_rand(), true) . $str);
     ...
     * @param $code
     */
    public function saveLoginInfo($uuid, $code)
    {
        return true;
    }
    ...
    protected function logoutGlobal()
    {
        switch ($this->loginType) {
            ...
            case "cache":
                $session_id_check = Cookie::get("session_id");
                Cache::delete("uuid_{$session_id_check}");
                Cache::delete("member_info_{$session_id_check}");
